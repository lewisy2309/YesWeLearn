...
<section class="hero-section set-bg" data-setbg="{{ asset('img/hero.jpg') }}">
    <div class="container">
        <div class="row">
            <div class="col-lg-7">
                <div class="hero-text">
                    <h2>Apprenez d'où vous voulez avec <span class="-">Yes We Learn GABON</span></h2>
                    <ul class="list-group">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                ...
                <img src="{{asset('img/nsl.jpg')}}" alt="complexe_michel_dirat" width="550px">
                </div>-+            </div>
            <div class="col-lg-6">
                <div class="ha-text">
                    ...
                    <ul>
                        ...
                        <li><i class="fas fa-check"></i> SEquipes professionelles toujours à disposition </li>
